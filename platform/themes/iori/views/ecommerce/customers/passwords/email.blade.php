<section>
    <div class="container text-center customer-reset-password">
       <div>
           ...
           <p class="font-md color-grey-500 wow animate__animated animate__fadeIn mb-10" data-wow-delay=".2s">{{ __('BizSite is a Multipurpose Agency Laravel Script. It is a powerful, clean, modern, and fully responsive template. It is designed for agency, business, corporate, creative, freelancer, portfolio, photography, personal, resume, and any kind of creative fields.') }}</p>
