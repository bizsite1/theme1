...
class ThemeOptionSeeder extends BaseSeeder
{
    ...
    public function run(): void
    {
        ...
        $this->createThemeOptions([
            ...
            'site_description' => 'BizSite is a Multipurpose Agency Laravel Script. It is a powerful, clean, modern, and fully responsive template. It is designed for agency, business, corporate, creative, freelancer, portfolio, photography, personal, resume, and any kind of creative fields.',
            'copyright' => sprintf('©%s Tanxor . All right reserved.', Carbon::now()->year),
